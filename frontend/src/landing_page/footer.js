      ...
      <div className="container  mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <p className="text-muted mt-3">&copy;2010 - 2025, Zerodha Broking Ltd. All rights reserved.</p>
          </div>
          <div className="col">
            <p>Company</p>
            ...
            <br></br>
            <a href="" className="text-muted mb-5"  style={{textDecoration:"none"}}>Referral programme</a>
            <br></br>
            <a href="" className="text-muted mb-5"  style={{textDecoration:"none"}}>Careers</a>
            <br></br>
            <a href="" className="text-muted mb-5"  style={{textDecoration:"none"}}>Zerodha.tech</a>
            <br></br>
            <a href="" className="text-muted mb-5"  style={{textDecoration:"none"}}>Open source</a>
            <br></br>
            <a href="" className="text-muted mb-5"  style={{textDecoration:"none"}}>Press & media</a>
            <br></br>
